	...
	<div class="wrapper">
				...
				<div class="sidebar-content js-simplebar">
					...
					<ul class="sidebar-nav">
						...
						<?php if($_SESSION['role'] == 'student' || $_SESSION['role'] == 'teacher' || $_SESSION['role'] == 'admin'): ?>
							...
							<li class="sidebar-item ">
								<a class="sidebar-link" href="stu_quiz_results.php">
									<i class="align-middle" data-feather="user"></i> <span class="align-middle">My Quiz Resuts</span>
								</a>
							</li>
						<?php endif; ?>
			...
			<main class="content">
				<!-- <div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"><strong>Students</strong> Dashboard</h1>




				</div> -->
				<h2>Welcome to Dashboard Area!</h2>
			</main>
