				...
				<div class="container-fluid p-0">
                    ...
                    <script>
                            ...
                            const questionTemplate = `
                                <div class="question" id="question-${questionIndex}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="questions[${questionIndex}][question_name]" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="questions[${questionIndex}][time_alloted]">Time Alloted (seconds)</label>
                                        <input type="number" class="form-control" name="questions[${questionIndex}][time_alloted]" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Options</label>
                        ...
                        function addOption(questionIndex) {
                            const optionIndex = document.querySelectorAll(`#options-container-${questionIndex} .option`).length;
                            const optionTemplate = `
                                <div class="option">
                                    <div class="form-group">
                                        <label for="questions[${questionIndex}][options][${optionIndex}][option_text]">Option ${optionIndex + 1}</label>
                                        <input type="text" class="form-control" name="questions[${questionIndex}][options][${optionIndex}][option_text]" required>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" name="questions[${questionIndex}][options][${optionIndex}][is_right]">
